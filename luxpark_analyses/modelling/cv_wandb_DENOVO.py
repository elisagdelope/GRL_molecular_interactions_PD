...
if __name__ == '__main__':
    ...
    metab_file = "../data/DENOVO_data_metab_mmi_STITCH_700.csv"
    labels_file = "../data/DENOVO_labels_4ML.csv"
    mmi_score_file = "../data/DENOVO_mmi_score_STITCH_700.csv"
    adj_file = "../data/DENOVO_A_mmi_weighted_STITCH_700.csv" 
